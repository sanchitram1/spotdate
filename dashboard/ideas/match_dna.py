...
class MatchDNAIdea(ImplementationIdea):
    ...
    def build(self, context: PairContext, config: DashboardConfig = CONFIG) -> DNAPayload:
    ...
    def render(self, payload: DNAPayload, context: PairContext, config: DashboardConfig = CONFIG) -> None:
        figure = go.Figure(
            data=[
                go.Pie(
