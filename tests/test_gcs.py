...
def main():
    try:
        ...
        print(f"Connected to storage service")
        print(f"Bucket: {storage.bucket_name}")
        print(f"Emulator: {os.getenv('STORAGE_EMULATOR_HOST', 'Not set (using production)')}\n")
        ...
        print("  2. DATA_BUCKET_NAME is set (e.g., spotdate-oauth-flow)")
